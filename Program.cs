using _2401377C.Components;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.DependencyInjection;
using _2401377C.Data;
using _2401377C.Components.Account;
...
builder.Services.AddIdentityCore<_2401377CUser>(options => options.SignIn.RequireConfirmedAccount = true)
    .AddEntityFrameworkStores<_2401377CContext>()
    .AddSignInManager()
